...
module.exports = function(args) {
    ...
    var xz_appid = process.env.BAIDU_XZ_URL_SUBMIT_APPID || config.baidu_url_submit.xz_appid;
    var xz_token = process.env.BAIDU_XZ_URL_SUBMIT_TOKEN || config.baidu_url_submit.xz_token;
